...
import com.stone.othercomponent.ClearCacheTask;
import com.stone.othercomponent.ConnectionChangeReceiver;
import com.stone.support.database.AccountDBTask;
import com.stone.support.database.DatabaseManager;
...
import com.stone.ui.dm.DMUserListFragment;
import com.stone.ui.interfaces.IAccountInfo;
import com.stone.ui.interfaces.IUserInfo;
import com.stone.ui.maintimeline.FriendsTimeLineFragment;
import com.stone.ui.search.SearchMainParentFragment;
import com.stone.ui.send.WriteWeiboActivity;
import com.stone.ui.userinfo.MyFavListFragment;
import com.stone.ui.userinfo.NewUserInfoFragment;
import com.stone.ui.userinfo.UserInfoActivity;

public class MainTimeLineActivity extends MainTimeLineParentActivity implements
		IUserInfo, IAccountInfo {
	...
	private void buildInterface(Bundle savedInstanceState) {
		...
		if (phone) {
			bulidPhoneInterface(savedInstanceState);
		} else {
	...
	private void configSlidingMenu(boolean phone) {
		...
		if (phone) {
			...
			slidingMenu.setBehindOffsetRes(Utility.getScreenWidth());
		}
	...
	private void buildCustomActionBarTitle(Bundle savedInstanceState) {
		...
		write.setOnClickListener(new View.OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent intent = new Intent(MainTimeLineActivity.this,
	...
	protected void srcollCurrentListViewToTop() {
	...
	private void bulidPhoneInterface(Bundle savedInstanceState) {
	...
	public NewUserInfoFragment getMyProfileFragment() {
		NewUserInfoFragment fragment = ((NewUserInfoFragment) getSupportFragmentManager()
				.findFragmentByTag(NewUserInfoFragment.class.getName()));
		if (fragment == null) {
			fragment = NewUserInfoFragment.newInstance(GlobalContext
